...
\begin{center}
    ...
    \url{https://github.com/ZiDiYao/RBF_SVM_Model_ML}
\end{center}
...
identify high-risk patients using routinely collected medical measurements.Several existing studies have explored this predictive task using classical
and modern machine learning techniques\cite{vdSchaar2019healthcare}
...
SVMs are widely used in medical classification tasks due to their robustness
in high-dimensional spaces and ability to model nonlinear boundaries\cite{jayadeva2007twinSVM}
...
nonlinear relationships needed for accurate classification.This behaviour is consistent with prior observations that neural networks
often struggle to outperform classical models on structured tabular datasets\cite{ivanov2020tabular}
